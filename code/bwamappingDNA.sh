...
bwa index data/assembly_fulhack/fulhack_contigs.fa
...
bwa mem /home/edvo1850/genome_analysis_2019/data/assembly_fulhack/fulhack_contigs.fa $pathdna/SRR4342133_1.paired.trimmed.fastq.gz $pathdna/SRR4342133_2.paired.trimmed.fastq.gz > SRR4342133.sam
